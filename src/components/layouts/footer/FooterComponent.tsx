            ...
            <div className="md:flex md:justify-between">
                <div className="mb-6 px-2 w-full md:w-1/3 md:mb-0">
                    {/* <a href="../index.html" className="flex items-center"> */}
                        <Image src={"/assets/logo.jpg"} className="rounded-full" width={80} height={80}  alt="E-Coding Logo" />
                        <span className="self-center text-3xl roboto-bold   bg-clip-text  whitespace-nowrap font-bold">IVSHOPS</span>
